...
| [ADR-WSF-32](./ADR-WSF-32-Ecosystem-Structural-Primitives.md) | Ecosystem Structural Primitives | Proposed (Pre-Baseline) |
...
ADR-WSF-29  Domain-Extension Numbering & Categorisation Convention (Convention)
   ↓
ADR-WSF-32  Ecosystem Structural Primitives          (Domain Extension: Ecosystem, Structural Primitives; Pre-Baseline)
```
...
| **Domain Extension: Ecosystem (Structural Primitives)** | ADR-WSF-32 |
